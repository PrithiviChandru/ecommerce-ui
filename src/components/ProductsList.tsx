...
export const ProductsList: React.FC<ProductsListProps> = ({ token, onBack }) => {
  ...
  const handleUpdateProduct = async (e: React.FormEvent) => {
    ...
    if (editStock === '' || editStock < 0) {
      setEditError('Please enter a valid stock level.');
      return;
    }
    ...
    <div style={{ width: '100%', animation: 'fade-in 0.4s ease-out' }}>
      ...
      {loading ? (
        <div style={{
          ...
          <p style={{ color: '#475569', fontSize: '14px', fontWeight: 500 }}>Loading store products...</p>
        </div>
      ) : error ? (
        <div style={{
          background: '#fef2f2',
          ...
          <h3 style={{ fontSize: '16px', fontWeight: 700, color: '#991b1b', marginBottom: '6px' }}>Failed to retrieve products</h3>
        ...
        <div style={{
          ...
          <ShoppingBag size={36} style={{ color: '#94a3b8', marginBottom: '12px' }} />
          <h3 style={{ fontSize: '16px', fontWeight: 700, color: '#0f172a', marginBottom: '6px' }}>No products found</h3>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#f8fafc' }}>
                  <th style={{ padding: '16px 24px', fontSize: '12px', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Product Details</th>
                  ...
                  <th style={{ padding: '16px 24px', fontSize: '12px', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Category</th>
                  <th style={{ padding: '16px 24px', fontSize: '12px', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Price</th>
                  <th style={{ padding: '16px 24px', fontSize: '12px', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Stock</th>
                  <th style={{ padding: '16px 24px', fontSize: '12px', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', textAlign: 'right' }}>Actions</th>
                </tr>
              </thead>
              <tbody>
                {filteredProducts.map((product) => {
                  return (
                    ...
                    >
                      ...
                      {/* Description */}
                      <td style={{ padding: '16px 24px', fontSize: '13px', color: '#475569', maxWidth: '240px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {product.description || <span style={{ color: '#94a3b8', fontStyle: 'italic' }}>No description</span>}
                      </td>

                      {/* Category */}
                      <td style={{ padding: '16px 24px' }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '4px 10px', borderRadius: '12px', background: '#ede9fe', border: '1px solid #c7d2fe', fontSize: '12px', color: '#4338ca', fontWeight: 600 }}>
                          <Tag size={12} />
                      ...
                      <td style={{ padding: '16px 24px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '14px', fontWeight: 700, color: '#0f172a' }}>
                          <IndianRupee size={14} style={{ color: '#64748b' }} />
                      ...
                      <td style={{ padding: '16px 24px' }}>
                        <div style={{
                          ...
                          <Archive size={13} style={{ opacity: 0.8 }} />
            ...
            <form onSubmit={handleCreateProduct}>
              <div style={{ padding: '24px', maxHeight: '70vh', overflowY: 'auto' }}>
                ...
                <div className="form-group" style={{ marginBottom: '18px' }}>
                  ...
                  >
                    <option value="" style={{ background: '#ffffff', color: '#0f172a' }}>Select a category</option>
                    {categories.map((c) => (
                ...
                <div style={{ display: 'flex', gap: '16px', marginBottom: '18px' }}>
                  ...
                  <div className="form-group" style={{ flex: 1 }}>
                    <label style={{ display: 'block', marginBottom: '8px', fontSize: '13px', fontWeight: 600, color: '#1e293b' }}>
                      Price (INR) <span style={{ color: '#dc2626' }}>*</span>
                    </label>
                    <input
                      type="number"
                      placeholder="e.g. 799"
        ...
        >
          ...
          >
            <div style={{ padding: '24px' }}>
              ...
              <h3 style={{ fontSize: '18px', fontWeight: 700, margin: '0 0 8px 0', color: '#0f172a', fontFamily: 'var(--font-display)' }}>
                Delete Product
              </h3>
              <p style={{ fontSize: '14px', color: '#475569', margin: '0 0 20px 0', lineHeight: 1.5 }}>
                Are you sure you want to delete <strong style={{ color: '#0f172a' }}>{deletingProduct.name}</strong>? This action cannot be undone and will permanently remove the product from the catalog.
              </p>
